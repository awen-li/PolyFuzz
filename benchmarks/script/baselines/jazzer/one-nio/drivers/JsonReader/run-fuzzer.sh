...
python $BENCH/script/popen_log.py "./jazzer --instrumentation_includes=one.nio.** --cp=$target:$ONENIO_PATH --target_class=JsonReaderDrv.JsonReaderDrv ./tests" &
