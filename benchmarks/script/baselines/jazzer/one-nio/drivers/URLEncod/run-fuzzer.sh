...
export TARGET_JAR=URLEncod.jar
...
afl-fuzz $1 $2 -i in/ -o out -m none -d -- javawrapper java -cp $TARGET_JAR:$JavaCovPCG/JavaCovPCG.jar:$ONENIO_PATH URLEncodDrv.URLEncodDrv  @@
